...
if(isset($_POST["submit"])){
    ...
    $cin=$formData["cin"];
    $cne=$formData["cne"];
    $date=$formData["date_naissance"];
    $ville=$formData["ville_naissance"];
    $bac=$formData["serie_bac"];
    $mention_bac=$formData["mention_bac"];
    $bac_2=$formData["bac_2"];
    $bac_3=$formData["bac_3"];
    $s1=$formData["note_s1"]; $s2=$formData["note_s2"]; $s3=$formData["note_s3"];
    $s4=$formData["note_s4"]; $s5=$formData["note_s5"]; $s6=$formData["note_s6"];
    $selected_cycles=$formData["cycles"];
...
<body>
    <form action="download_file.php" method="post">
        <input type="submit" value="download pdf" name="submit">
    </form>
</body>
</html>